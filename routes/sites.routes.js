...
router.get('/buscar/:sitio', isAuth, canView, siteController.get_buscar);
...
router.post('/add', isAuth, canCreate, siteController.post_new);
router.get('/:sites_id', isAuth, canView, siteController.get_list);
